    ...
    return (
        <div className="flex flex-col items-center max-w-md bg-white px-10 py-3 shadow-2xl rounded-xl">
            <div className="p-0 mb-2 w-1/3">
                <img src={profilePhoto} alt="Profile Photo" className="rounded-full m-0 border-4 border-indigo-500" />
            </div>
            ...
            <div className="mt-3 px-7 flex items-center flex-wrap justify-center text-white">
                <a className="btn-indigo" href="/cv">
                    CV
                </a>
                <a className="btn-indigo" href="/blog">
                    Blog
                </a>
                <a className="btn-indigo" href="/projects">
                    Projects
                </a>
                <a className="btn-indigo" href="https://github.com/EduRibeiro00">
                    GitHub
                </a>
                <a className="btn-indigo" href="https://www.linkedin.com/in/eduardo-ribeiro-a3a5b9192/">
                    LinkedIn
                </a>
            </div>
        </div>

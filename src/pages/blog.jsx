...
const Blog = ({ data }) => {
    return (
        <Layout>
            ...
            <p className="my-4">I also post on other platforms, so make sure you follow me on <a href={data.dataJson.dev.link}>DEV</a> and <a href={data.dataJson.medium.link}>Medium</a> 😃</p>
